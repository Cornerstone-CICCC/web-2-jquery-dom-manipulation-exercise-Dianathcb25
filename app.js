...
// $(function() {
    ...
    $("#exercise2Button").on('click', function() {
      $("#exercise2 p").parent("div").css({backgroundColor: "#a40061"})
    });
    ...
    $("#exercise3Button").on('click', function() {
      $("#exercise3 p").parents("div").css({backgroundColor: "lightBlue"})
    });
    ...
    $("#exercise5Button").on('click', function() {
      $(this).siblings().children("p").css({border: "3px solid #a40061"})
    });
    ...
    $("#exercise6Button").on('click', function() {
      $(this).siblings("div").last().children().children().last().css({color: "red"})
    });
// })